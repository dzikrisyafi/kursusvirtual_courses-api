...
type gradesRepositoryInterface interface {
	DeleteGrades(int) rest_errors.RestErr
}

func (r *gradesRepository) DeleteGrades(courseID int) rest_errors.RestErr {
	response := quizRestClient.Delete(fmt.Sprintf("/internal/grades/courses/%d", courseID))
